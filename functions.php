...
function rollie_script_start() {
	...
	wp_enqueue_script( 'rollie_ajax', get_template_directory_uri() . '/js/rollie_ajax.js', array( 'jquery' ), '1.0' );
	wp_localize_script(
		'rollie_ajax',
		'rollie_ajax_obj',
		array(
	...
	wp_enqueue_script( 'rollie_js', get_template_directory_uri() . '/js/rollie.js', array(), gmdate( 'h:i:s' ), 'true' );
	wp_enqueue_script( 'tocca', get_template_directory_uri() . '/js/Tocca.min.js', array(), '2.0.4', 'true' );
...
function rollie_style_start() {
	...
	wp_enqueue_style( 'rollie_stylesheet', get_template_directory_uri() . '/css/rollie.css', array(), gmdate( 'h:i:s' ), 'all' );

	if ( class_exists( 'WooCommerce' ) ) {
		wp_enqueue_style( 'woocommerce_stylesheet', WP_PLUGIN_URL . '/woocommerce/assets/css/woocommerce.css', false, '1.0', 'all' );
		wp_enqueue_style( 'rollie_woo_stylesheet', get_template_directory_uri() . '/css/rollie_woocommerce.css', array(), gmdate( 'h:i:s' ), 'all' );
	}
...
function rollie_customize_script() {
	wp_enqueue_script( 'rollie_customizer_preview', get_template_directory_uri() . '/js/rollie_customizer_preview.js', array( 'jquery', 'customize-preview' ), gmdate( 'h:i:s' ), true );
	if ( class_exists( 'WooCommerce' ) ) {
		wp_enqueue_script( 'rollie_woo_customizer_preview', get_template_directory_uri() . '/js/rollie_woo_customizer_preview.js', array( 'jquery', 'customize-preview' ), gmdate( 'h:i:s' ), true );
	}
}
...
function rollie_customizer_stylesheet() {
	...
	wp_enqueue_style( 'rollie_customizer', get_template_directory_uri() . '/css/rollie_customizer.css', array(), '1.0', 'all' );
...
function rollie_customizer_scripts() {
	...
	wp_enqueue_script( 'font_awesome', get_template_directory_uri() . '/js/rollie_font_awesome.js', array(), '1.00', true );
}
