...
if ( 2 == get_theme_mod( 'rollie_grid_masonry_type' . $rollie_template_sufix, 1 ) ) {
	$rollie_post_display_style_classes [0]['first_div_col'] = ' rollie_grid_masonry_item ';
	$rollie_post_display_style_classes [1]['first_div_col'] = ' rollie_grid_masonry_item ';
	$rollie_post_display_style_classes [2]['first_div_col'] = ' rollie_grid_masonry_item ';
}
