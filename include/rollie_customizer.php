...
$rollie_sufix='_'.$rollie_sufix;
	...
	$wp_customize->add_setting(	'rollie_design_label'.$rollie_sufix);
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_0'.$rollie_sufix, // rollie_one_on_row_design_0
			array(
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_1'.$rollie_sufix, // rollie_two_on_row_design_1
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_2'.$rollie_sufix, // rollie_three_on_row_design_2
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
	...
	$wp_customize->add_control(
		...
		new Rollie_Customizer_Collapse_Label_Control(
			...
			array(
				'label'   =>__( 'Post Metainfos', 'rollie' ),
				'section'       => 'rollie_post_page'.$rollie_sufix,
				'input_attrs'=> array (
				'rollie_collapse_elements_number'=> 5,
				'rollie_open_close_auto'=>true,
		...
		$wp_customize->add_control(
			...
			$wp_customize->add_setting(
		'rollie_posts_page_title_single_row'.$rollie_sufix,
		array(
			'default'           => true,
			'transport'         => 'refresh',
	...
	$wp_customize->add_control(
		new Skyrocket_Toggle_Switch_Custom_control(
			...
			'rollie_posts_page_title_single_row'.$rollie_sufix,
			array(
				'label'   =>__( 'Display titles and excerpt in single row', 'rollie' ),
				'section' => 'rollie_post_page'.$rollie_sufix,
...
function rollie_customizer_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			$wp_customize->add_control(
				new Skyrocket_Toggle_Switch_Custom_control(
					...
					'rollie_search_form_menu_top_type',
					array(
						'label'   => __( 'Display search icon only ', 'rollie' ),
						'section' => 'rollie_menu_top_section',
	...
	$wp_customize->add_section(
		...
		array(
			'title'    =>__( 'Main Blog Page settings', 'Rollie' ),
			'panel'    => 'rollie_grid_meta_panel',
			'priority' => 20,
		)
	);
			$wp_customize->add_setting(	'rollie_grid_label');
		$wp_customize->add_control(
		new Rollie_Customizer_Collapse_Label_Control(
			$wp_customize,
			'rollie_grid_label',
		...
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				'input_attrs' => array(
					...
					'max'  => 50,
					'step' => 1,
				'rollie_multiple_switch_cc' => 'rollie_grid_type-2'
				),
							...
							$wp_customize->add_setting(
			'rollie_post_page_masonry_size_m',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_control(
		...
		$wp_customize->add_control(
			new Skyrocket_Toggle_Switch_Custom_control(
				...
				array(
					...
					'description' => 'If is off the next page is styled by "display for rest of the posts style" value ',
						'input_attrs'=>array(
								'rollie_multiple_switch_cc' => 'rollie_grid_type-1'
		...
		$wp_customize->add_setting(
			'rollie_post_page_one_on_row_php', // panoramix
			array(
				'sanitize_callback' => 'absint',
				'default'           => 1,
				'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_one_on_row_php',
			array(
				'label'   =>__( 'How many posts you want to display as one on row ', 'Rollie' ),
				'section' => 'rollie_posts_page_section',
				'type'    => 'number',
					'input_attrs'=>array(
				'rollie_multiple_switch_cc' => 'rollie_grid_type-1'
			...
			$wp_customize->add_setting(
				'rollie_post_page_two_on_row_php',
				array(
					'sanitize_callback' => 'absint',
					'default'           => 2,
					'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_two_on_row_php',
			array(
				'label'   =>__( 'How many posts you want to display as two on row ', 'Rollie' ),
				'section' => 'rollie_posts_page_section',
				'type'    => 'number',
						'input_attrs'=>array(
				'rollie_multiple_switch_cc' => 'rollie_grid_type-1'
	...
	$wp_customize->add_setting(
		'rollie_post_page_default_style_php',
		array(
			'sanitize_callback' => 'rollie_sanitize_radio',
			'default'           => 3,
		...
		$wp_customize->add_control(
			new Rollie_Icon_Customize_Control(
				...
				'rollie_post_page_default_style_php',
				array(
					'label'   =>__( 'What style of display you want to choose for rest of the posts', 'Rollie' ),
					'section' => 'rollie_posts_page_section',
					'type'    => 'radio',
					'choices' => array(
						1 =>__( 'fa-bars split on row ', 'rollie' ),
	...
	$wp_customize->add_setting(	'rollie_design_label');
		$wp_customize->add_control(
		new Rollie_Customizer_Collapse_Label_Control(
			$wp_customize,
			'rollie_design_label',
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_php_0', // rollie_one_on_row_design_php_0
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_php_1', // rollie_two_on_row_design_php_1
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_php_2', // rollie_three_on_row_design_php_2
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
			...
			array(
				...
				'choices' => array(
					...
					3 =>__( 'Clean', 'rollie' ),
						...
						$wp_customize->add_setting(
							'rollie_post_page_raw_enable_php',
							array(
								'default'           => false,
								'sanitize_callback' => 'rollie_sanitize_checkbox',
							)
	...
	$wp_customize->add_control(
		new Skyrocket_Toggle_Switch_Custom_control(
			...
			$wp_customize->add_setting(	'rollie_meta_label');
		$wp_customize->add_control(
		new Rollie_Customizer_Collapse_Label_Control(
			$wp_customize,
			'rollie_meta_label',
	...
	$wp_customize->add_section(
		...
		array(
			'title'    =>__( 'Category page settings', 'Rollie' ),
			'panel'    => 'rollie_grid_meta_panel',
			'priority' => 20,
		)
	);
			...
			$wp_customize->add_control(
				new Rollie_Multiple_Switch_Customizer_Control(
					...
					array(					
						...
						$wp_customize->add_setting(
			'rollie_post_page_masonry_size_ct',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
		...
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				'input_attrs' => array(
					...
					'max'  => 50,
					'step' => 1,
				'rollie_multiple_switch_cc' => 'rollie_grid_type_ct-2'
				),
							...
							$wp_customize->add_setting(
			'rollie_post_page_masonry_size_m_ct',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_control(
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				$wp_customize->add_setting(
			'rollie_post_page_masonry_ma_ct',
			array(
				'default'           => 3,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_setting(
		'rollie_post_page_row_design_ct_php_0',
		array(
			'sanitize_callback' => 'rollie_sanitize_select',
			'default'           => 1,
			...
			array(
				...
				'choices' => array(
					...
					3 =>__( 'Clean', 'rollie' ),
							...
							'input_attrs'=>array(
				'rollie_multiple_switch_cc' => 'rollie_grid_type_ct-1'
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_ct_php_1', // rollie_two_on_row_design_php_1
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_ct_php_2', // rollie_three_on_row_design_php_2
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_control(
			...
			'input_attrs'=>array(
				...
				$wp_customize->add_setting(
					'rollie_post_page_raw_enable_ct_php',
					array(
						'default'           => false,
						'sanitize_callback' => 'rollie_sanitize_checkbox',
					)
		...
		$wp_customize->add_setting(
			'rollie_post_page_one_on_row_ct_php', // panoramix
			array(
				'sanitize_callback' => 'absint',
				'default'           => 1,
				'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_one_on_row_ct_php',
			array(
				'label'   =>__( 'How many posts you want to display as one on row ', 'Rollie' ),
				'section' => 'rollie_category_page_section',
				'type'    => 'number',
		'input_attrs'=>array(
			...
			$wp_customize->add_setting(
				'rollie_post_page_two_on_row_ct_php', // panoramix
				array(
					'sanitize_callback' => 'absint',
					'default'           => 2,
					'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_two_on_row_ct_php',
			array(
				'label'   =>__( 'How many posts you want to display as two on row ', 'Rollie' ),
				'section' => 'rollie_category_page_section',
				'type'    => 'number',
	...
	$wp_customize->add_setting(
		'rollie_post_page_default_style_ct_php',
		array(
			'sanitize_callback' => 'rollie_sanitize_radio',
			'default'           => 3,
		...
		$wp_customize->add_setting(
			'rollie_post_page_grid_for_paged_ct_php',
			array(
				'default'           => true,
				'sanitize_callback' => 'rollie_sanitize_checkbox',
			)
	...
	$wp_customize->add_control(
		...
		$wp_customize->add_control(
			new Skyrocket_Toggle_Switch_Custom_control(
				$wp_customize,				'rollie_display_date_ct',				
 				array(
 					'label'   =>__( 'Display date', 'rollie' ),
					'section' => 'rollie_category_page_section',
	...
	$wp_customize->add_setting(
 	...
 	$wp_customize->add_control(
		...
		$wp_customize->add_section(
			...
			array(
				'title'    =>__( 'Archive page settings', 'Rollie' ),
				'panel'    => 'rollie_grid_meta_panel',
				'priority' => 20,
			)
		);
			...
			$wp_customize->add_control(
				new Rollie_Multiple_Switch_Customizer_Control(
					...
					array(					
						...
						$wp_customize->add_setting(
			'rollie_post_page_masonry_size_ar',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
		...
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				'input_attrs' => array(
					...
					'max'  => 50,
					'step' => 1,
				'rollie_multiple_switch_cc' => 'rollie_grid_type_ar-2'
				),
							...
							$wp_customize->add_setting(
			'rollie_post_page_masonry_size_m_ar',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_control(
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				$wp_customize->add_setting(
			'rollie_post_page_masonry_ma_ar',
			array(
				'default'           => 3,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_setting(
		'rollie_post_page_row_design_ar_php_0',
		array(
			'sanitize_callback' => 'rollie_sanitize_select',
			'default'           => 1,
				'input_attrs' => array(
				'rollie_multiple_switch_cc' => 'rollie_grid_type_ar-1'
				),
		)
	);
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_ar_php_1', // rollie_two_on_row_design_php_1
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_ar_php_2', // rollie_three_on_row_design_php_2
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_control(
			...
			array(
				...
				$wp_customize->add_setting(
					'rollie_post_page_raw_enable_ar_php',
					array(
						'default'           => false,
						'sanitize_callback' => 'rollie_sanitize_checkbox',
					)
		...
		$wp_customize->add_control(
			new Skyrocket_Toggle_Switch_Custom_control(
				...
				'rollie_multiple_switch_cc' => 'rollie_grid_type_ar-1'
										...
										$wp_customize->add_setting(
											'rollie_post_page_grid_for_paged_ar_php',
											array(
												'default' => true,
												'sanitize_callback' => 'rollie_sanitize_checkbox',
											)
		...
		$wp_customize->add_setting(
			'rollie_post_page_one_on_row_ar_php', // panoramix
			array(
				'sanitize_callback' => 'absint',
				'default'           => 1,
				'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_one_on_row_ar_php',
			array(
				'label'   =>__( 'How many posts you want to display as one on row ', 'Rollie' ),
				'section' => 'rollie_archive_page_section',
				'type'    => 'number',
			...
			$wp_customize->add_setting(
				'rollie_post_page_two_on_row_ar_php', // panoramix
				array(
					'sanitize_callback' => 'absint',
					'default'           => 2,
					'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_two_on_row_ar_php',
			array(
				'label'   =>__( 'How many posts you want to display as two on row ', 'Rollie' ),
				'section' => 'rollie_archive_page_section',
				'type'    => 'number',
	...
	$wp_customize->add_setting(
		'rollie_post_page_default_style_ar_php',
		array(
			'sanitize_callback' => 'rollie_sanitize_radio',
			'default'           => 3,
	...
	$wp_customize->add_control(
		...
		$wp_customize->add_section(
			...
			array(
				'title'    =>__( 'Search page settings', 'Rollie' ),
				'panel'    => 'rollie_grid_meta_panel',
				'priority' => 20,
			)
		);
			...
			$wp_customize->add_control(
				new Rollie_Multiple_Switch_Customizer_Control(
					...
					array(					
						...
						$wp_customize->add_setting(
			'rollie_post_page_masonry_size_se',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
		...
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				'input_attrs' => array(
					...
					'max'  => 50,
					'step' => 1,
				'rollie_multiple_switch_cc' => 'rollie_grid_type_se-2'
				),
							...
							$wp_customize->add_setting(
			'rollie_post_page_masonry_size_m_se',
			array(
				'default'           => 33,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_control(
		new Skyrocket_Slider_Custom_Control(
			...
			array(
				...
				$wp_customize->add_setting(
			'rollie_post_page_masonry_ma_se',
			array(
				'default'           => 3,
				'transport' =>'refresh',
				'sanitize_callback' => 'skyrocket_sanitize_integer',
	...
	$wp_customize->add_setting(
		'rollie_post_page_row_design_se_php_0',
		array(
			'sanitize_callback' => 'rollie_sanitize_select',
			'default'           => 1,
		...
		$wp_customize->add_control(
			...
			array(
				...
				'choices' => array(
					...
					'input_attrs' => array(
					'rollie_multiple_switch_cc' => 'rollie_grid_type_se-1'
				),
			)
		);

		$wp_customize->add_setting(
			'rollie_post_page_row_design_se_php_1', // rollie_two_on_row_design_php_1
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_setting(
			'rollie_post_page_row_design_se_php_2', // rollie_three_on_row_design_php_2
			array(
				'sanitize_callback' => 'rollie_sanitize_select',
				'default'           => 1,
		...
		$wp_customize->add_control(
			...
			array(
				...
				$wp_customize->add_setting(
					'rollie_post_page_raw_enable_se_php',
					array(
						'default'           => false,
						'sanitize_callback' => 'rollie_sanitize_checkbox',
					)
			...
			new Skyrocket_Toggle_Switch_Custom_control(
				...
				array(
					...
					'rollie_multiple_switch_cc' => 'rollie_grid_type_se-1'
										...
										$wp_customize->add_setting(
											'rollie_post_page_grid_for_paged_se_php',
											array(
												'default' => true,
												'sanitize_callback' => 'rollie_sanitize_checkbox',
											)
		...
		$wp_customize->add_setting(
			'rollie_post_page_one_on_row_se_php', // panoramix
			array(
				'sanitize_callback' => 'absint',
				'default'           => 1,
				'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_one_on_row_se_php',
			array(
			...
			$wp_customize->add_setting(
				'rollie_post_page_two_on_row_se_php', // panoramix
				array(
					'sanitize_callback' => 'absint',
					'default'           => 2,
					'transport'         => 'refresh',
		...
		$wp_customize->add_control(
			'rollie_post_page_two_on_row_se_php',
			array(
	...
	$wp_customize->add_setting(
		'rollie_post_page_default_style_se_php',
		array(
			'sanitize_callback' => 'rollie_sanitize_radio',
			'default'           => 3,
