...
$rollie_current_template = 'posts_page';
 ...
 if (get_theme_mod('rollie_'.$rollie_current_template.'_l',2) == 2   ) $rollie_multiply =0;
...
if (get_theme_mod('rollie_'.$rollie_current_template.'_l_ignore',false)  ){
	...
	if (get_theme_mod('rollie_'.$rollie_current_template.'_l',2) == 3 ){
	$rollie_allow_sidebar_r = true;
	$rollie_allow_sidebar_l = true;
	}	
	elseif(get_theme_mod('rollie_'.$rollie_current_template.'_l',2) == 1){
	$rollie_allow_sidebar_r = false;
	$rollie_allow_sidebar_l = true;
	}
	elseif(get_theme_mod('rollie_'.$rollie_current_template.'_l',2) == 4){
	$rollie_allow_sidebar_r = true;
	$rollie_allow_sidebar_l = false;
	}else{	
	$rollie_allow_sidebar_r = false ;
