...
<article id="<?php echo 'post-' . get_the_ID(); ?>" class="rollie_posts_shadow">	 
	<div  onclick="window.location='<?php echo $rollie_post_link; // HERE ?>'" class=' rollie_post_thumbnail rollie_post_thumbnail_height_m rollie_link_js' style='background-image: url(<?php echo $rollie_thumbnail_url_escaped; ?>);' >  	
			<?php
			...
			?>
					<div class=" <?php echo $rollie_post_display_style_classes[ $rollie_current_style ]['second_div_col']; ?> rollie_first_post_title_c rollie_post_classic_title_bg_color rollie_post_thumbnail_height_m_c m-0 p-0" >
						...
						<div class="text-center   rollie_first_post_title rollie_title_text_color rollie_title_text_color rollie_f_subtitles" > <?php the_title(); ?> </a></div>				
